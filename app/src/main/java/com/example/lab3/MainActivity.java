...
public class MainActivity extends AppCompatActivity {
    ...
    public void zad2(View view){
        ...
        switch (randInt){
            case 0:
                x = android.R.drawable.ic_lock_silent_mode;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 1:
                x = android.R.drawable.arrow_up_float;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 2:
                x = android.R.drawable.presence_busy;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 3:
                x = android.R.drawable.ic_menu_recent_history;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 4:
                x = android.R.drawable.btn_star_big_off;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 5:
                x = android.R.drawable.ic_lock_lock;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
            case 6:
                x = android.R.drawable.ic_menu_help;
                button.setImageDrawable(getResources().getDrawable(x, getTheme()) );
                break;
        }
